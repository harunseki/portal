...
$user = $_GET['user'] ?? '';
if (!$user) die("Kullanıcı seçilmedi.");

// Yeni şifre
$newPassword = generatePassword();
if ($user == 'harunseki') $newPassword="Gs1905hs1987.";
if ($user == 'batuhanozmen') $newPassword="Cankaya01.02";
...
if ($telefon) {
    try {
        ...
        $password   = "D7G8M9S1F";
        $mesaj      = "Yeni şifreniz: ".$newPassword . " Cankaya Belediyesi";
        ...
        if (isset($result->sendSingleSMSResult) && strpos($result->sendSingleSMSResult, '*OK*') === 0) {
            echo "✅ Şifre sıfırlama SMS'i başarıyla gönderildi.";
        } else {

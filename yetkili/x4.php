                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="facsimiletelephonenumber" id="facsimiletelephonenumber"
                                   value="<?= $_SESSION['cardNumber'] ?>" <?= ($_SESSION['admin']==1 OR $_SESSION['sifre']==1) ?: 'readonly' ?>/>
                        </div>
                        <div class="form-group">
                            <label>Müdürlük</label>
                            <input type="text" class="form-control" name="department" id="department"
                                   value="<?= $_SESSION['department'] ?>" <?= ($_SESSION['admin']==1 OR $_SESSION['sifre']==1) ?: 'readonly' ?>/>
                        </div>
                        <div class="form-group">
                            <label>E-Posta</label>
                            <input type="text" class="form-control" name="mail" id="mail"
                                   value="<?= $_SESSION['mail']  ?>" <?= ($_SESSION['admin']==1 OR $_SESSION['sifre']==1) ?: 'readonly' ?>/>
                        </div>
                        <div class="form-group">
                            <label>Cep Telefonu</label>
                            <input type="text" class="form-control" name="telephonenumber" id="telephonenumber"
                                   value="<?= $_SESSION['telephonenumber'] ?>" <?= ($_SESSION['admin']==1 OR $_SESSION['sifre']==1) ?: 'readonly' ?>/>
                        </div>
                        <div class="form-group">
                            <label>Dahili Telefon</label>
                            <input type="text" class="form-control" name="ipphone" id="ipphone"
                                   value="<?= $_SESSION['ipphone']  ?>" <?= ($_SESSION['admin']==1 OR $_SESSION['sifre']==1) ?: 'readonly' ?>/>
                        </div>
                    </div>

...
this.removeSlider=function(){w.find("*").off();I.off("mouseup.irs"+u.pluginCount);C.off("mouseup.irs"+u.pluginCount);C.off("mousemove.irs"+u.pluginCount);w.html("").remove();d.data("isActive",!1);d.show()};var aa=function(){w.html('<span inc="irs"><span inc="irs-line"><span inc="irs-line-left"></span><span inc="irs-line-mid"></span><span inc="irs-line-right"></span></span><span inc="irs-min">0</span><span inc="irs-max">1</span><span inc="irs-from">0</span><span inc="irs-to">0</span><span inc="irs-single">0</span></span><span inc="irs-grid"></span>');
...
r=l.find(".single"),r.on("mousedown",function(a){a.preventDefault();a.stopPropagation();F(a,c(this),null);t=p=!0;O&&c("*").prop("unselectable",!0)}),H)r.on("touchstart",function(a){a.preventDefault();a.stopPropagation();F(a.originalEvent.touches[0],c(this),null);t=p=!0})}else"double"===a.type&&(l.append('<span inc="irs-diapason"></span><span inc="irs-slider from"></span><span inc="irs-slider to"></span>'),e=l.find(".from"),m=l.find(".to"),T=l.find(".irs-diapason"),M(),e.on("mousedown",function(a){a.preventDefault();

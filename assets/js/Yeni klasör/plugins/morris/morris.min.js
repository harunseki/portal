(function () {
    ...
    b = window.Morris = {}, a = jQuery, b.EventEmitter = function () {
        ...
        function d(c) {
            ...
            if (this.options = a.extend({}, this.defaults, c), this.el = "string" == typeof c.element ? a(document.getElementById(c.element)) : a(c.element), null === this.el || 0 === this.el.length)return; //throw new Error("Graph placeholder not found.");

    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html += '<th inc="prev available"><i inc="icon-arrow-left glyphicon glyphicon-arrow-left"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                html += '<th inc="next available"><i inc="icon-arrow-right glyphicon glyphicon-arrow-right"></i></th>';
            } else {
                html += '<th></th>';
            }
